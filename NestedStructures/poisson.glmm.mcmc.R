#
#
# Bayesian Poisson generalized linear mixed model
#
# Function name: poisson.glmm.MCMC
#
...
poisson.glmm.mcmc <- function(z,X,g,priors,start,tune,adapt=TRUE,n.mcmc=1000){
