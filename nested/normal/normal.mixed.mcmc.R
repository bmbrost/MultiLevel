normal.mixed.mcmc <- function(y,X,Z,priors,start,sigma.alpha=NULL,n.mcmc){
	...
	### alpha~N(mu.alpha,sigma.alpha^2*I)
	### mu.alpha~N(0,sigma.mu.alpha^2*I	
	...
	for (k in 1:n.mcmc) {
		...
		###
		###  Sample mu.alpha (mean of parameter model for alpha)
		###
