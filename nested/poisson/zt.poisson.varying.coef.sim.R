###
### Simulate zero-inflated, grouped count data and fit model
### using zt.poisson.varying.coef.mcmc.R
###
...
source('~/Documents/git/Multilevel/nested/poisson/zt.poisson.varying.coef.mcmc.R')
